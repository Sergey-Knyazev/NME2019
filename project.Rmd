...
duration1 = 22
net1<-my_net(net_par1, n, dissolution_coefs(~offset(edges), duration1))
...
duration2 = 26
net2<-my_net(net_par2, n, dissolution_coefs(~offset(edges), duration2))
